...
@app.post("/api/analyze", response_model=ComputeResponse)
async def analyze_measurements(data: ComputeRequest):
    return await compute_measurements(data)

@app.post("/compute", response_model=ComputeResponse)
async def compute_measurements_alias(data: ComputeRequest):
    return await compute_measurements(data)
